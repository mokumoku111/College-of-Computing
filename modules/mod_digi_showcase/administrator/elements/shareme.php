...
class JFormFieldShareMe extends JFormField {
    ...
    protected function getInput() {
        ...
        // bug apologies
        $html .= '<div class="share-me" id="digigreg_shareme_bug_apologies"><span class="label label-warning">'.JText::_(strToUpper($extension_system_name).'_FIELD_SHAREME_WE_ARE_SORRY').'</span></div>';
        ...
        // customization link
		$html .= '<div class="share-me" id="digigreg_shareme_more_request"><a class="btn btn-default btn-small" href="mailto:info@digigreg.com" target="_blank" title="'.JText::_(strToUpper($extension_system_name).'_FIELD_SHAREME_CUSTOMIZATION_DESC').'"><i class="icon-info"></i> '.JText::_(strToUpper($extension_system_name).'_FIELD_SHAREME_CUSTOMIZATION_TITLE').'</a></div>';
